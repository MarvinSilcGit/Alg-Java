...
public final class ProfissionalEnfermagem_SaudeMulher extends ProfissionalEnfermagem
{
   
   public ProfissionalEnfermagem_SaudeMulher()
   {
      
   }//Fim do método construtor personalizado;
   
   public ProfissionalEnfermagem_SaudeMulher (String nome, int cpf, Date dataNascimento, float salario, String setor, Date dataAdmissao, String email, Endereco endereco, Telefone telefone, String coren)
   {
...
}//Fim da classe ProfissionalEnfermagem_SaudeMulher;