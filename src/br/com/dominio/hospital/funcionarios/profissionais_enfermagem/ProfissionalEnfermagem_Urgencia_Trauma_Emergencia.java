...
public final class ProfissionalEnfermagem_Urgencia_Trauma_Emergencia extends ProfissionalEnfermagem
{
   ...
   public ProfissionalEnfermagem_Urgencia_Trauma_Emergencia (String nome, int cpf, Date dataNascimento, float salario, String setor, Date dataAdmissao, String email, Endereco endereco, Telefone telefone, String coren)
   {
