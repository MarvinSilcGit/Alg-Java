...
public final class ProfissionalEnfermagem_TerapiaItensiva extends ProfissionalEnfermagem
{
   
   public ProfissionalEnfermagem_TerapiaItensiva()
   {
      
   }//Fim do método construtor padrão;
   
   public ProfissionalEnfermagem_TerapiaItensiva  (String nome, int cpf, Date dataNascimento, float salario, String setor, Date dataAdmissao, String email, Endereco endereco, Telefone telefone, String coren)
   {   
...
}//Fim da classe ProfissionalEnfermagem_TerapiaItensicva;