...
public final class ProfissionalEnfermagem_Traumato_Ortopedia extends ProfissionalEnfermagem
{
   
   public ProfissionalEnfermagem_Traumato_Ortopedia()
   {
      
   }//Fim do método construtor padrão;
   
   public ProfissionalEnfermagem_Traumato_Ortopedia (String nome, int cpf, Date dataNascimento, float salario, String setor, Date dataAdmissao, String email, Endereco endereco, Telefone telefone, String coren)
   {
