...
public class Neurologista extends ProfissionalMedicina
{
   ...
   public Neurologista (String nome, int cpf, Date dataNascimento, float salario, String setor, Date dataAdmissao, String email, Endereco endereco, Telefone telefone, int crm)
   {
