...
public class Traumatologista extends ProfissionalMedicina
{
   ...
   public Traumatologista (String nome, int cpf, String setor, Date dataAdmissao, String email, Endereco endereco, Telefone telefone, int crm, float valorConsulta)
   {
