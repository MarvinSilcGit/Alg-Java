...
public final class CirurgiaoOrtopedista extends ProfissionalMedicinaCirurgia
{
   
   public CirurgiaoOrtopedista()
   {
      
   }//Fim do método construtor padrão;
   
   public CirurgiaoOrtopedista (String nome, int cpf, Date dataNascimento, float salario, String setor, Date dataAdmissao, Endereco endereco, Telefone telefone, String email, int crm, float valorCirurgia)
   {
...
}//Fim da classe CirugiaoOrtopedista;