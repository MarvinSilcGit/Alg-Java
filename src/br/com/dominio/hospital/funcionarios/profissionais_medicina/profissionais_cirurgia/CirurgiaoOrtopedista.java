...
public final class CirurgiaoOrtopedista extends ProfissionalMedicinaCirurgia
{
   ...
   public CirurgiaoOrtopedista (String nome, int cpf, String setor, Date dataAdmissao, String email, Endereco endereco, Telefone telefone, int crm, float valorConsulta, float valorCirurgia)
   {
