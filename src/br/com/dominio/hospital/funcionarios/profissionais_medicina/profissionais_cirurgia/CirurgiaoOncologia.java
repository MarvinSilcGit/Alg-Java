...
public class CirurgiaoOncologia extends ProfissionalMedicinaCirurgia
{
   
   public CirurgiaoOncologia()
   {
      
   }//Fim do método construtor padrão;
   
   public CirurgiaoOncologia (String nome, int cpf, Date dataNascimento, float salario, String setor, Date dataAdmissao, Endereco endereco, Telefone telefone, String email, int crm, float valorCirurgia)
   {
...
}//Fim da classe CirurgiaoOncologia;