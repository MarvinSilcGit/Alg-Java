...
public class CirurgiaoOncologia extends ProfissionalMedicinaCirurgia
{
   ...
   public CirurgiaoOncologia (String nome, int cpf, String setor, Date dataAdmissao, String email, Endereco endereco, Telefone telefone, int crm, float valorConsulta, float valorCirurgia)
   {
