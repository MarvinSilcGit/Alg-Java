...
public class CirurgiaoTraumatologia extends ProfissionalMedicinaCirurgia
{
   ...
   public CirurgiaoTraumatologia(String nome, int cpf, String setor, Date dataAdmissao, String email, Endereco endereco, Telefone telefone, int crm, float valorConsulta, float valorCirurgia)
   {
