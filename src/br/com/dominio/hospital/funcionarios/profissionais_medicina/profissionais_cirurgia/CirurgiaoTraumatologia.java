...
public class CirurgiaoTraumatologia extends ProfissionalMedicinaCirurgia
{
   
   public CirurgiaoTraumatologia()
   {
      
   }//Fim do método construtor padrão;
   
   public CirurgiaoTraumatologia(String nome, int cpf, Date dataNascimento, float salario, String setor, Date dataAdmissao, Endereco endereco, Telefone telefone, String email, int crm, float valorCirurgia)
   {
...
}//Fim da classe CirurgiaoTraumatologia;